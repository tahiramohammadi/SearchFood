...
const FoodSearch = () => {
  ...
  const closeDialog = () => {
    ...
    return(
        <div className="bg-black  pl-16  pr-16">
        ...
        <button className="text-yellow-500  p-4 rounded-r-lg  bg-gray-700" onClick={ handleSearch}> Search</button>
     
        </div>
        {loading && <p>Loading...</p>}
        {error && <p className="text-red-500 mt-12 font-extrabold text-6xl text-center">{error}</p>}
